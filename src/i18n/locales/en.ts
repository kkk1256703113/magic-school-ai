export default {
  ...
  upgrade: {
    ...
    kofi: {
      ...
      newUser1: '🆓 20 free calls for new users',
  ...
  usage: {
    ...
    newUserGift: 'You have 20 free API calls to try our service',
  ...
  subscription: {
    ...
    newUserTip: 'New users get 20 free API calls to try our service. Top up for more calls after using them.',
  ...
  landing: {
    hero: {
      ...
      cta: 'Start Free',
      ctaSubtitle: '20 free tries for new users',
      demo: 'View Demo',
    ...
    cta: {
      ...
      feature2: '20 free tries for new users',
